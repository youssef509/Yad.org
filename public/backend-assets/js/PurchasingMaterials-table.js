        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `
                        <a href="/admin/Quote-Requeste/PurchasingMaterials/${row.id}/edit" class="btn btn-success btn-sm">تعديل</a>
                        <form method="POST" action="/admin/Quote-Requeste/PurchasingMaterials/${row.id}/delete" class="delete-form" style="display: inline;">
