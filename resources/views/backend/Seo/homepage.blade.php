                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> SEO |   الصفحة الرئيسية</h4>
                            </div>
                            <div class="card-body p-4">
                                ...
                                @endif
                                <form method="POST" action="{{ $Data ? route('seo-aboutpage-update', $Data->id) : route('seo-aboutpage-store') }}" enctype="multipart/form-data">
                                    @csrf
                                    @if($Data)
                                        @method('PUT')
                                    @endif
