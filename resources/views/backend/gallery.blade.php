                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-title-desc">قسم معرض الصور في الصفحة الرئيسية</p>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">قائمة معرض الصور</h4>
                                    </div>
                                    <div class="card-body p-4">
                                        <div class="container text-center">
                                            <div class="row">
                                                @foreach ($gallery as $singelgallery)
                                                <div class="col-4">
                                                    <!-- Simple card -->
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="{{ $singelgallery->image_url }}" alt="Card image cap">
                                                        <div class="card-body">
                                                            <p class="card-text">{{$singelgallery->alt}}</p>
                                                            <form method="POST" action="{{route('admin.gallery-destroy', $singelgallery->id)}}" class="delete-form" style="display: inline">
                                                                @csrf
                                                                @method('DELETE')
